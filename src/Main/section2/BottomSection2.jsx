    ...
    return (
        <div className="flex flex-col lg:flex-row gap-10 justify-center">
            <div className="flex flex-col md:flex-row gap-10">
                <Card className="mt-6 w-72 text-center shadow-none flex flex-col items-center">
                    <CardHeader className="relative bg-transparent shadow-none flex justify-center text-[#2A3855] py-10 px-10 bg-[#fAfAfA] border border-blue-gray-200 w-max rounded-full">
                        <svg className="w-12 h-12" aria-hidden="true" focusable="false"
                            data-prefix="far" data-icon="chart-bar" role="img" xmlns="http://www.w3.org/2000/svg"
                ...
                <Card className="mt-6 w-60 text-center shadow-none flex flex-col items-center">
                    <CardHeader className="relative bg-transparent shadow-none flex justify-center text-[#2A3855] py-10 px-10 bg-[#fAfAfA] border border-blue-gray-200 w-max rounded-full">
