import bgimage from './images/video-screenshot-2.jpg'

export const TopSection3 = () => {
    return (
        <div className='container'>
            <div className='flex w-full items-center bg-no-repeat bg-cover bg-bg-image justify-center'>
